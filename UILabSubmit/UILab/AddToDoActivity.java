	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				/*View  selectedPriority = mPriorityRadioGroup.findViewById(mPriorityRadioGroup.getCheckedRadioButtonId());
				int index = mPriorityRadioGroup.indexOfChild(selectedPriority);
				switch(index){
					case 0:priority = Priority.LOW; break;
					case 1:priority = Priority.MED; break;
					case 2:priority = Priority.HIGH; break;
					default: priority = Priority.MED;
				}*/
				// TODO - Get the current Status
				Status status = getStatus();
				/*View selectedStatus = mPriorityRadioGroup.findViewById(mPriorityRadioGroup.getCheckedRadioButtonId());
				index = mPriorityRadioGroup.indexOfChild(selectedStatus);
				switch (index){
					case 0: status = Status.DONE; break;
					case 1:status = Status.NOTDONE; break;
					default: status = Status.NOTDONE;
				}*/
